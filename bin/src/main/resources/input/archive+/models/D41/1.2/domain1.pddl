...
:precondition (and (currstate t0) (currstate s_0_35) (currstate s_1_0) )
:effect (and (currstate s_1_abstract) (not (currstate s_1_0)) )
)

(:action goto-abstract_states-cs1
:precondition (and (currstate t0) (currstate s_0_35) (currstate s_1_3) )
:effect (and (currstate s_1_abstract) (not (currstate s_1_3)) )
)

(:action goto-abstract_states-cs2
:precondition (and (currstate t0) (currstate s_0_35) (currstate s_1_2) )
